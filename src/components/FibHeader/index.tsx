...
const Header: React.FC = () => {
  ...
  const totalSupplyInNum = getBalanceNumber(marketInfo.totalSupply, 9);
        ...
        <div className="current_price">
          ...
          <div>
            <h3>
              ...
              <a
                className="chicon"
                href="https://poocoin.app/tokens/0x5067c6e9E6c443372f2E62946273ABbF3Cc2f2B3"
                target="_blank"
                rel="noreferrer"
              >
          ...
          <div className="btnOuter">
            <a
              href="https://bsc.fibswap.io/swap?outputCurrency=0x5067c6e9E6c443372f2E62946273ABbF3Cc2f2B3"
              className="border"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://bscscan.com/address/0x5067c6e9E6c443372f2E62946273ABbF3Cc2f2B3"
              target="_blank"
              rel="noreferrer"
            >
              FIBO Smart Contract
