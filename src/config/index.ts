...
export const BASE_EXPLORER_URL = 'https://bscscan.com'
export const DEFAULT_CHAIN_ID = 56

export const DEFAULT_GAS_LIMIT = 200000
export const DEFAULT_GAS_PRICE = 5
export const NATIVE_TOKEN_ADDRESS = '0xa30BAba694b8Fc3524C46edC5af295F55381dc60'
export const NATIVE_TOKEN_SYMBOL = 'ORIO'
export const FIBO_TOKEN_ADDRESS = '0x5067c6e9E6c443372f2E62946273ABbF3Cc2f2B3'
...
export const CHAIN_CONFIG={
    97:{
      ...
      subgraph: '',
      image: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@d5c68edec1f5eaec59ac77ff2b48144679cebca1/svg/color/bnb.svg'
    },
    42161:{
      name: 'Arbitrum One',
      shortName: 'Arbitrum',
